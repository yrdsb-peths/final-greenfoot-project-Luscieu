 ...
 */
public class Level5 extends MyWorlds
{
    Wood wood;
    Ball ball;
    int once = 0;
    ...
    public Level5()
    {
        ...
        */
        ...
        for(int i = 0; i<2;i++)
        {
            addObject(new Rock(20),280,230-60*i);
            
            addObject(new Rock(20),390, 270-60*i);
            addObject(new Wood(20), 225, 255-20*i);
            
            addObject(new Wood(20), 310,170-30*i);
            addObject(new Wood(20), 420,210-30*i);
        }
        addObject(new Rock(20), 200, 250);
        addObject(new Glass(20), 225, 265);
        addObject(new Pig(20), 225, 200);
        addObject(new Glass(20), 310,200);
        addObject(new Glass(20), 420,240);
        addObject(new Pig(20), 310,100);
        addObject(new Pig(20), 420,100);
    ...
    public void gameOver()
    {
        ...
        addObject(new Level5Button(), 330,270);
    }
}
